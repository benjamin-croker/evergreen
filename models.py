...
class ClassifierModel(object):
    ...
    def fit(self, X_train, y):
        ...
        """
        logging.debug("Fitting {} model".format(str(self)))
        self._model.fit(X_train, y)

    def predict(self, X_predict, data_note="test"):
        logging.debug("{}: Predicting for {} data".format(str(self), data_note))
    ...
    def one_fold_eval(self, train_indices, fold_eval_indices, fold_n):
        logging.debug("{}: Evaluating fold {} of {}".format(str(self), fold_n + 1, self._AUCs.size))
    ...
    def last_eval(self):
        logging.info("{} overall AUC: mean={}, std={}".format(str(self), self._AUCs.mean(), self._AUCs.std()))
        return self._AUCs
...
class Stacker(object):
    ...
    def fit_predict(self):
        ...
        """
        logging.debug("{}: Fitting model and predicting data".format(str(self)))
    ...
    def submission(self):
        logging.info("{}: making a submission dataframe".format(str(self)))
